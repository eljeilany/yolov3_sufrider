...
hyp = {'giou': 3.54,  # giou loss gain
       ...
       'degrees': 8 *1,  # image rotation (+/- deg)
       'translate': 0.1*1,  # image translation (+/- fraction)
...
def train():
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if (not opt.notest and epoch%10==9 )or final_epoch:  # Calculate mAP
...
if __name__ == '__main__':
    ...
    parser.add_argument('--img-size', nargs='+', type=int, default=[64*8], help='[min_train, max-train, test] img sizes')
